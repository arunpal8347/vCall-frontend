...
import { CallEnd, Description, Stream, VideocamOff } from '@mui/icons-material';
...
export default function VideoMeetComponent(){
    ...
    let connectToSocketServer = () => {
        ...
        socketRef.current.on("connect", () => {
            ...
            // EXTRA: handle user leaving properly
            socketRef.current.on("user-left", (id) => {
    ...
    useEffect(() => {
        ...
        // Listen when a user leaves the call
        socket.on("user-left", (userId) => {
            console.log("User left:", userId);

            setVideos((prevVideos) => {
                // Remove the leaving user
                const updatedVideos = prevVideos.filter((video) => video.socketId !== userId);
